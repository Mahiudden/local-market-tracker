...
export default function BecomeAdmin() {
  ...
  const handleAdminRequest = async (e) => {
    ...
    try {
      await requestAdmin(user.uid); // ভবিষ্যতে reason পাঠাতে চাইলে API-তে যুক্ত করতে হবে
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        <div className="bg-white rounded-xl shadow p-8 text-center">
          <h2 className="text-xl font-bold mb-4 text-blue-700">এডমিন হওয়ার জন্য আবেদন করতে লগইন করুন</h2>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-green-50 py-10 px-4">
      <div className="bg-white rounded-3xl shadow-2xl p-10 w-full max-w-lg border border-blue-100">
        <h2 className="text-3xl font-extrabold text-blue-700 mb-6 text-center tracking-tight">এডমিন হওয়ার জন্য আবেদন</h2>
        <p className="text-gray-600 text-center mb-8">আপনার তথ্য দিন এবং কেন আপনি এডমিন হতে চান তা লিখুন। এডমিন রিভিউ করে সিদ্ধান্ত নেবে।</p>
          ...
          <form onSubmit={handleAdminRequest} className="flex flex-col gap-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="আপনি কেন এডমিন হতে চান, সংক্ষেপে লিখুন..."
                value={reason}
            ...
            >
              {adminRequestLoading ? 'পাঠানো হচ্ছে...' : 'আবেদন সাবমিট করুন'}
            </button>
          </form>
        )}
        ...
        {adminRequestStatus === 'accepted' && (
          <div className="text-green-600 font-semibold mt-2 text-center text-lg">আপনি এখন একজন এডমিন!</div>
        )}
