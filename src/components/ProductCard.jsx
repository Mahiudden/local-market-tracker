...
const ProductCard = ({ market, date, products, image, onViewDetails }) => {
  return (
    <motion.div
    ...
    >
      ...
      {/* Product Name বড় করে উপরে */}
      {/* <div className="font-bold text-blue-700 text-xl mb-2 text-center truncate w-full">{products[0]?.name}</div> */}
      {/* Market Name নিচে আইকন সহ */}
      <div className="mb-3 flex items-center gap-2 justify-center">
        <FaStore className="text-yellow-400 text-xl" />
        <span className="font-semibold text-blue-600 group-hover:text-blue-900 transition">{market}</span>
      </div>
